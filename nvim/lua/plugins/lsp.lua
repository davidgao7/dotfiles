...
return {
    -- Core Treesitter functionality and parser management
    {
        ...
        opts = {
            ...
            ensure_installed = {
                'c', 'lua', 'vim', 'vimdoc', 'query', 'javascript', 'typescript', 'python', 'rust', 'go', 'html', 'css',
                'markdown', 'bash', 'json', 'yaml',
            ...
            textobjects = {
                ...
                swap = {
                    enable = true,
                    swap_next = {
                        ['<leader>na'] = { query = '@parameter.inner', desc = 'swap parameters/arguments with next (TS)' },
                    },
                    swap_previous = {
                        ['<leader>pa'] = { query = '@parameter.inner', desc = 'swap parameters/arguments with previous (TS)' },
                    },
                },
            },
